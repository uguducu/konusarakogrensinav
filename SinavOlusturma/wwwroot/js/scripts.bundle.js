            ...
            toolbar: {
                pagination: {
                    items: {
                        ...
                        info: 'Gösteriliyor {{start}} - {{end}} Toplam {{total}}',
                    },
                },
            },
        },
...
var KTQuickSearch = function () {
    ...
    var processSearch = function () {
        ...
        setTimeout(function () {
            $.ajax({
                type: "POST",
                url: '/api/AramadaFormlarıListele',
                data: {
                    query: query
                },
                dataType: 'html',
                success: function (res) {
                    ...
                    hideProgress();
                    KTUtil.addClass(target, resultClass);
                    KTUtil.setHTML(resultWrapper, res.baslik);
                    showDropdown();
                    KTUtil.scrollUpdate(resultWrapper);
                },
                error: function (res) {
                    ...
                    hideProgress();
                    KTUtil.addClass(target, resultClass);
                    KTUtil.setHTML(resultWrapper, '<span class="kt-quick-search__message">Bir sorun oluştu. Lütfen daha sonra tekrar deneyiniz.</div>');
                    showDropdown();
                    KTUtil.scrollUpdate(resultWrapper);
                }
            });
