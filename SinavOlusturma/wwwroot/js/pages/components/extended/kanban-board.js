			...
			boards  :[
				{
					...
					'item'  : [
						...
						{
							'title':'<div class="kt-kanban__badge"><div class="kt-kanban__image kt-media"><img src="media/users/100_5.jpg" alt="image"></div><div class="kt-kanban__content"><div class="kt-kanban__title">Documentation</div><span class="kt-badge kt-badge--dark kt-badge--inline">Backlog</span></div></div>',
						}
					]
				},
				{
					...
					'item'  : [
						{
							'title':'<div class="kt-kanban__badge"><div class="kt-kanban__image kt-media"><img src="media/users/100_3.jpg" alt="image"></div><div class="kt-kanban__content"><div class="kt-kanban__title">SEO Optimization</div><span class="kt-badge kt-badge--danger kt-badge--inline">To Do</span></div></div>',
						},
						{
				...
				},
				{
					...
					'item'  : [
						{
							'title':'<div class="kt-kanban__badge"><div class="kt-kanban__image kt-media"><img src="media/users/100_1.jpg" alt="image"></div><div class="kt-kanban__content"><div class="kt-kanban__title">Responsive UI</div><span class="kt-badge kt-badge--brand kt-badge--inline">In Progress</span></div></div>',
						},
						{
				...
				},
				{
					...
					'item'  : [
						...
						{
							'title':'<div class="kt-kanban__badge"><div class="kt-kanban__image kt-media"><img src="media/users/100_4.jpg" alt="image"></div><div class="kt-kanban__content"><div class="kt-kanban__title">Server Setup</div><span class="kt-badge kt-badge--success kt-badge--inline">Completed</span></div></div>',
						}
					]
				},
				{
					...
					'item'  : [
						...
						{
							'title':'<div class="kt-kanban__badge"><div class="kt-kanban__image kt-media"><img src="media/users/100_2.jpg" alt="image"></div><div class="kt-kanban__content"><div class="kt-kanban__title">Proofreading</div><span class="kt-badge kt-badge--primary kt-badge--inline">Deploy</span></div></div>',
						}
					]
				}
			]
